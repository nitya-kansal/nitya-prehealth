/* =========================================================================
   ...
   HOW IT'S ORGANIZED
     categories  →  a group like "Bookish Beginnings", "Awards", etc.
  ...
  categories: [
    ...
    /* ---------- 1) BOOKISH BEGINNINGS ---------- */
    {
      ...
      albums: [
        ...
        {
          title: '500-Book Donation — Kentlake HS',
          date: '2023',
          cover: 'assets/images/book-kentlake/cover.jpg',
          photos: [
            { src: 'assets/images/book-kentlake/cover.jpg', caption: 'Recognition for 500+ books donated' }
          ]
        }
